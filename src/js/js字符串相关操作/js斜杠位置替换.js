// 调process(n)函数 处理 str = “abc/def/ghij/klm” 输出字符串，去掉对应的位置n的/
// eg: process(0)  输出 “abc/def/ghij/klm”
// eg: process(1)  输出 “abcdef/ghij/klm”
// eg: process(2)  输出 “abc/defghij/klm”

// 第一种方式 不太好
// let str = "abc/def/ghij/klm";
// function process(n) {
//     if (n < 1) return str;
//     let tempArr = [];
